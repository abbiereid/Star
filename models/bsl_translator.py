...
with open('C:/Users/abbie/Desktop/Star/models/bsl-dataset/one_hand_model.pkl', 'rb') as f:
    one_hand_model = pickle.load(f)
    
with open('C:/Users/abbie/Desktop/Star/models/bsl-dataset/two_hand_model.pkl', 'rb') as f:
